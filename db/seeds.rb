...
User.create(email: "rian@example.com", password: "password", password_confirmation: "password")
User.create(email: "fifi@example.com", password: "password", password_confirmation: "password")
