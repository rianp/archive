...
class UploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upload" do
    assert_difference("Upload.count") do
      post uploads_url, params: { upload: { description: @upload.description, name: @upload.name, thumbnail: @upload.thumbnail } }
    end
  ...
  test "should update upload" do
    patch upload_url(@upload), params: { upload: { description: @upload.description, name: @upload.name, thumbnail: @upload.thumbnail } }
