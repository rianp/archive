...
class ResourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resource" do
    assert_difference("Resource.count") do
      post resources_url, params: { resource: { link: @resource.link, name: @resource.name } }
    end
  ...
  test "should update resource" do
    patch resource_url(@resource), params: { resource: { link: @resource.link, name: @resource.name } }
